...
func TestEncodeTLV_codecov(t *testing.T) {
	...
	tlvVerifyLengthState(&BERPacket{offset: 1}, []byte{0xa, 0x80, 0x83, 0x01, 0xe4}, nil)
	tlvVerifyLengthState(&BERPacket{offset: 1}, []byte{0xa, 0x03, 0x83, 0x01, 0xe4}, nil)
	tlvVerifyLengthState(&BERPacket{offset: 1}, []byte{0x04, 0x82, 0x00, 0x80, 0x83, 0x01, 0xe4, 0x1e, 0x2a}, nil)
	tlvVerifyLengthState(&BERPacket{offset: 1}, []byte{0x02, 0x81, 0x7F, 0x83, 0x01, 0xe4, 0x1e, 0x2a}, nil)
